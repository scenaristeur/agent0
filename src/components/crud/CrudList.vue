<template>
  <div>
    ...
    <b-button size="sm mr-2" variant="outline-primary">
      ...
      <span class="material-icons" @click.stop="edit(i)" variant="primary">
        edit
      </span>
    </b-button>
    <!-- <b-button size="sm mr-2" variant="outline-primary">
  ...
  <b-button size="sm" variant="outline-danger">
    ...
    <span class="material-icons" @click.stop="init_trash(i)" variant="danger">
      delete
    </span>
  </b-button>
...
export default {
  ...
  methods: {
    ...
    init_trash(item){
      ...
      if (window.confirm("Do you really want to delete "+item.name+" (id: "+item.id+") ?")) {
        this.currentItem = item
        this.trash()
      }
